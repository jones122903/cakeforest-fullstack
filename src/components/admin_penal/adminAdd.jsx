                            ...
                            <div className={styles.photoUploadBox}>
                                <label className={styles.uploadLabel}>
                                    ...
                                    <div className={styles.photoCircle}>
                                        {imagePreview ? (
                                            <img src={imagePreview} alt="Cake" className={styles.photoImage} />
                                        ) : (
                      ...
                      <div className='col-12 col-md-4 mt-4'>
                          <div className={styles.formBox}>
                                    <div className={styles.formGroup}>
                                        <label className={styles.staticLabel}>Availability Status</label>
                                        <div className={styles.radioGroup}>
                                            <label className={styles.radioLabel}>
                                                ...
                                                <span className={styles.radioText}>
                                                    <span className={styles.statusDot} data-status="available"></span>
                                                    Available
                                                </span>
                                            </label>
                                            <label className={styles.radioLabel}>
                                                ...
                                                />
                                                <span className={styles.radioText}>
                                                    <span className={styles.statusDot} data-status="out-of-stock"></span>
                                                    Out of Stock
                                                </span>
                                            </label>
                                        </div>
